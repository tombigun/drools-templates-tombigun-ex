...
public class SnippetBuilderTest {
    ...
    @Test
    public void testMacroEqual1() {
        final String snippet = "macro(equal, \"$\")";
        final SnippetBuilder snip = new SnippetBuilder(snippet);
        final String result = snip.build("x, y");
    ...
    @Test
    public void testMacroEqual3() {
        final String snippet = "macro(equal, \"$\")";
        final SnippetBuilder snip = new SnippetBuilder(snippet);
        final String result = snip.build("x, y, !z");
    ...
    @Test
    public void testMacroMatcher1() {
        final String snippet = "macro(matcher, \"$\")";
        final SnippetBuilder snip = new SnippetBuilder(snippet);
        final String result = snip.build("100, 200, 300");

        assertEquals("($ matches \"100.*\")||($ matches \"200.*\")||($ matches \"300.*\")", result);
    }

    @Test
    public void testMacroMatcher2() {
        final String snippet = "macro(matcher, \"$\")";
        final SnippetBuilder snip = new SnippetBuilder(snippet);
        final String result = snip.build("!100, !200, !300");

        assertEquals("($ not matches \"100.*\")&&($ not matches \"200.*\")&&($ not matches \"300.*\")", result);
    }

    @Test
    public void testMacroMatcher3() {
        final String snippet = "macro(matcher, \"$\")";
        final SnippetBuilder snip = new SnippetBuilder(snippet);
        final String result = snip.build("100, 200, !2001, !2002");

        assertEquals("($ matches \"100.*\")||($ matches \"200.*\"),($ not matches \"2001.*\")&&($ not matches \"2002.*\")", result);
    }
}
